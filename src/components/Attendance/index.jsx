...
export default function Attendance() {
  ...
  function Submit(e) {
    ...
    setLoading(true);
    fetch(
      "https://script.google.com/macros/s/AKfycbyehXLR7oxsUp1HdTPU6Jjl8X3wyOe0Av5wTulji8c25TuDI3hmJbp8kVhXQtaPibUt/exec",
      {
        method: "POST",
        body: formDatab,
      }
  ...
  return (
    <div className={styles.App}>
      <div className="form center mb-12 mt-10">
        <p className={` text-center text-4xl mb-[10px] color`}>
          Тойға келетіңізді
        </p>

        <p className={` text-center text-3xl mb-[40px] color`}>
          ...
          <form className="form" onSubmit={(e) => Submit(e)}>
            ...
            <div className={styles.radio}>
              ...
              <div className="flex items-center mb-2 ml-6">
                ...
                />
                <label htmlFor="willAttendWithWife" className="ml-2 color">
                  Жұбайымен
                </label>
              </div>
